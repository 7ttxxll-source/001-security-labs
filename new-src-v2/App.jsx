  ...
  useEffect(() => {
    ...
    const updateScroll = () => {
      ...
      site.style.setProperty(
        "--parallax-y",
        `${Math.min(window.scrollY * 0.055, 140)}px`,
      )
    }
...
function CreatorRights() {
  return (
    <aside className="creator-rights-wrap" data-reveal>
      ...
      <div className="creator-rights" data-tilt>
        <div className="creator-depth creator-depth-one" aria-hidden="true" />
        <div className="creator-depth creator-depth-two" aria-hidden="true" />
        ...
        <div className="creator-copy">
          ...
          <div className="creator-meta">
            ...
            <span>HAMOOD — 001</span>
          </div>

          <p className="creator-arabic" dir="rtl">
            تصميم وتطوير حصري — جميع الحقوق محفوظة
          </p>
        </div>
  ...
  return (
    <section className="creator-manifesto" data-reveal>
      ...
      <div className="manifesto-copy">
        ...
        <p dir="rtl">
          هذه المنصة وهوية منتجاتها مصممة لتكون حصرية وقابلة للتوسع، مع إبراز
          حقوق المطور بشكل واضح داخل التجربة نفسها.
        </p>
      </div>
