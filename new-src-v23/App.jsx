...
const navigationItems = [
  ...
  { label: "Guardian", href: "#guardian-product" },
  { label: "Guide", href: "#guardian-guide" },
...
const builtFromZeroPrinciples = [
  {
    ...
    arabic: "بنية أصلية",
    text: "كل نظام يبدأ من بنية خاصة فيه بدل الاعتماد على قالب جاهز أو منتج معاد تغليفه.",
  },
  {
    code: "02",
    title: "CUSTOM LOGIC",
    arabic: "منطق برمجي خاص",
    text: "آلية العمل والتدفقات الداخلية تُبنى حسب وظيفة كل بوت وتجربته المطلوبة.",
  },
  {
    code: "03",
    title: "PRODUCT IDENTITY",
    arabic: "هوية مستقلة",
    text: "لكل منتج اسم وهوية وتجربة استخدام وصفحة خاصة داخل منصة HAMOOD LABS.",
  },
  {
    code: "04",
    title: "BUILT IN-HOUSE",
    arabic: "تصميم وتطوير داخلي",
    text: "من الفكرة إلى الواجهة والمنطق النهائي، يتم بناء المنتجات داخل HAMOOD LABS من الصفر.",
  },
]

const guardianQuickFacts = [
...
const guardianGuideSteps = [
  {
    number: "01",
    title: "أضف Guardian للسيرفر",
    text: "ابدأ من زر التثبيت الرسمي داخل صفحة المنتج، واختر السيرفر المطلوب ثم أكمل صلاحيات Discord.",
  },
  {
    number: "02",
    title: "خله يجهز نفسه",
    text: "Auto Setup يجهز البنية الخاصة بالنظام ويحافظ عليها تلقائيًا بدون إعداد يدوي متكرر.",
  },
  {
    number: "03",
    title: "افتح لوحة Guardian",
    text: "استخدم لوحة Guardian الرئيسية لمراجعة حالة الحماية، الحوادث المفتوحة والتهديدات النشطة.",
  },
  {
    number: "04",
    title: "راجع الحادث قبل أي قرار",
    text: "افتح التحقيق وشوف المنفذ، الهدف، نوع التغيير، مستوى الخطورة ونسخة Black Box المرتبطة بالحادث.",
  },
  {
    number: "05",
    title: "اختر الاسترجاع أو الاعتماد",
    text: "إذا كان التغيير ضارًا استخدم الاسترجاع الآمن. وإذا كان مقصودًا اعتمده حتى يعرف Guardian أنه تغيير موثوق.",
  },
  {
    number: "06",
    title: "تعامل مع التهديد كعملية واحدة",
    text: "إذا ارتبطت عدة حوادث بنفس النشاط، Threat Core يجمعها ويعرضها كتهديد واحد مع خطة استرجاع متعددة الأهداف عند توفرها.",
  },
  {
    number: "07",
    title: "احتفظ بالسجل والأدلة",
    text: "راجع الحوادث واللقطات والتحقق من سلامة الأدلة لفهم ما حدث قبل تنفيذ أي إجراء إداري.",
  },
]

const guardianSystemDirectory = [
  { code: "LIVE", title: "الحماية المباشرة", text: "مراقبة الأحداث الأمنية الحساسة لحظة حدوثها وتحويلها لمسار أمني منظم." },
  { code: "ROLE", title: "حماية الرتب والصلاحيات", text: "رصد تغييرات الصلاحيات الخطرة وربطها بالمنفذ مع حفظ السياق الأمني." },
  { code: "CH", title: "حماية القنوات", text: "رصد حذف القنوات والتغييرات المدعومة وحفظ الحالة الهيكلية اللازمة للاسترجاع." },
  { code: "WH", title: "حماية Webhooks", text: "مراقبة إنشاء وتعديل وحذف Webhooks بدون تخزين Token أو رابط Webhook داخل الأدلة." },
  { code: "BOX", title: "Black Box", text: "لقطات جنائية موثقة مع SHA-256 لحماية سلامة الدليل وربطه بالحوادث." },
  { code: "INC", title: "Incident Engine", text: "تحويل الحدث الأمني إلى حادث منظم قابل للتحقيق والمراجعة واتخاذ القرار." },
  { code: "THR", title: "Threat Core", text: "ربط الحوادث المرتبطة ببعضها وتحليلها كتهديد واحد بدل تنبيهات منفصلة." },
  { code: "REC", title: "الاسترجاع الآمن", text: "فحص الحالة الحالية قبل التطبيق وتجهيز استرجاع مدعوم مع تحقق قبل وبعد التنفيذ." },
  { code: "TRU", title: "Trusted Actions", text: "تمييز عمليات Guardian الداخلية الموثوقة حتى لا تتحول عمليات الاسترجاع إلى إنذارات كاذبة." },
]
...
function Header() {
  return (
    <header className="navbar">
      ...
      <a className="nav-available" href="#available" aria-label="001 Guardian available now">
    ...
    <section className="hero" id="home">
      ...
      <div className="hero-content">
        ...
        <div className="hero-actions hero-enter hero-enter-five">
          ...
          <a className="secondary-button" data-magnetic href="#guardian-product">
...
function AvailableRelease() {
  return (
    <section className="available-release" id="available" data-reveal>
      <div className="available-grid" aria-hidden="true" />

      <div className="available-copy">
        <p className="eyebrow">LIVE RELEASE / 001</p>
        <div className="available-state"><i /> AVAILABLE NOW</div>
        <h2>001 GUARDIAN <span>جاهز للاستخدام.</span></h2>
        <p dir="rtl">
          أول نظام جاهز داخل HAMOOD LABS. تقدر تدخل صفحة المنتج، تعرف فكرته،
          تقرأ دليل الاستخدام كامل، وبعدها تثبته على سيرفرك من الرابط الرسمي.
        </p>

        <div className="available-actions">
          <a className="primary-button" data-magnetic href="#guardian-product">
            فتح صفحة النظام <span>←</span>
          </a>
          <a className="secondary-button" data-magnetic href="#guardian-guide">
            دليل الاستخدام <span>↓</span>
          </a>
        </div>
      </div>

      <div className="available-console" data-tilt>
        <div className="available-console-top">
          <span>001 / DEPLOYMENT STATUS</span>
          <strong><i /> READY</strong>
        </div>
        <div className="available-console-core">
          <div className="available-pulse" aria-hidden="true"><span>001</span></div>
          <div>
            <small>PRODUCT</small>
            <strong>GUARDIAN</strong>
            <small>SECURITY &amp; RECOVERY SYSTEM</small>
          </div>
        </div>
        <div className="available-console-footer">
          <span>VERSION <strong>V1.0.0</strong></span>
          <span>SETUP <strong>AUTOMATIC</strong></span>
...
function BuiltFromZero() {
  return (
    <section className="built-zero" data-reveal>
      <div className="built-zero-heading">
        <div>
          <p className="eyebrow">HAMOOD LABS / ORIGINAL SYSTEMS</p>
          <h2>BUILT FROM <span>ZERO.</span></h2>
        </div>
        <div dir="rtl">
          <strong>مو قوالب جاهزة. مو أنظمة معاد تغليفها.</strong>
          <p>
            جميع بوتات وأنظمة HAMOOD LABS يتم تصميمها وبرمجتها من الصفر؛ من
            بنية النظام والمنطق الداخلي إلى الواجهة وتجربة الاستخدام والهوية النهائية.
          </p>
        </div>
      </div>
      ...
      <div className="built-zero-signature" data-tilt>
        <div className="built-zero-seal"><span>H</span><small>001</small></div>
        <div>
          <span>ORIGINAL SYSTEMS / IN-HOUSE</span>
          <strong>BUILT &amp; DEVELOPED BY HAMOOD — 001</strong>
          <small dir="rtl">تصميم • برمجة • هوية • تجربة — من الصفر</small>
        </div>
      </div>
    </section>
  )
...
function GuardianProductHub() {
  return (
    <section className="guardian-product-hub" id="guardian-product">
      <div className="product-hub-head" data-reveal>
        <div>
          <p className="eyebrow">001 GUARDIAN / PRODUCT HUB</p>
          <h2>كل شيء عن <span>Guardian.</span></h2>
        </div>
        <div className="product-hub-intro" dir="rtl">
          <strong>نبذة سريعة</strong>
          <p>
            001 Guardian نظام حماية واستجابة لديسكورد يراقب التغييرات الحساسة،
            يحدد المنفذ، يحفظ الأدلة، يربط الحوادث ببعضها ويجهز الاسترجاع الآمن
            للعمليات المدعومة.
          </p>
        </div>
      </div>

      <div className="guardian-product-nav" data-reveal>
        <a href="#guardian-product"><span>01</span><strong>نبذة النظام</strong></a>
        <a href="#guardian-directory"><span>02</span><strong>وش يحمي؟</strong></a>
        <a href="#guardian-guide"><span>03</span><strong>دليل الاستخدام</strong></a>
        <a href="#guardian"><span>04</span><strong>الشرح التقني</strong></a>
        <a href="#support"><span>05</span><strong>الأسئلة الشائعة</strong></a>
        <a href="#guardian-install"><span>06</span><strong>التثبيت الرسمي</strong></a>
      </div>

      <div className="guardian-product-overview" data-reveal>
        <div className="guardian-overview-copy" dir="rtl">
          ...
          <p>
            Guardian مصمم عشان يعطيك القصة الكاملة للحادث: وش صار، مين نفذ
            التغيير، وش كانت الحالة، وين الدليل، وهل نقدر نسترجع الشيء بشكل آمن.
          </p>
          <div className="guardian-overview-actions">
            <a className="primary-button" data-magnetic href="#guardian-guide">
              ابدأ بدليل الاستخدام <span>↓</span>
            </a>
            <a
            ...
            >
              تثبيت 001 GUARDIAN <span>↗</span>
            </a>
          </div>
        </div>

        <div className="guardian-quick-facts">
          {guardianQuickFacts.map((item) => (
            <div key={item.label}>
      ...
      <div className="guardian-directory" id="guardian-directory" data-reveal>
        <div className="guardian-subheading">
          <p className="eyebrow">SYSTEM DIRECTORY / COMPLETE OVERVIEW</p>
          <h3 dir="rtl">قائمة تشرح النظام كامل.</h3>
          <p dir="rtl">
            هذه أهم أجزاء Guardian الحالية. اضغط أو مرر على أي جزء عشان تركز عليه،
            وبعدها تقدر تنزل للشرح التقني التفصيلي.
          </p>
        </div>

        <div className="guardian-directory-grid">
          {guardianSystemDirectory.map((item, index) => (
            <article key={item.code} data-tilt>
      ...
      <div className="guardian-guide" id="guardian-guide" data-reveal>
        <div className="guardian-subheading">
          <p className="eyebrow">OFFICIAL USER GUIDE / 001</p>
          <h3 dir="rtl">دليل الاستخدام — من التثبيت إلى الاسترجاع.</h3>
          <p dir="rtl">
            هذا المسار يعطي المستخدم الخطوات الأساسية لفهم Guardian واستخدامه
            بدون ما يحتاج يعرف تفاصيل تقنية من البداية.
          </p>
        </div>

        <div className="guardian-guide-grid">
          {guardianGuideSteps.map((step) => (
        ...
        <div className="guide-ready-bar" id="guardian-install">
          <div>
            <span><i /> READY TO DEPLOY</span>
            <strong dir="rtl">خلصت الدليل؟ ثبّت Guardian من الرابط الرسمي.</strong>
          </div>
          <a
            href={GUARDIAN_INVITE_URL}
            target="_blank"
    ...
    <section className="products-ecosystem" id="upcoming">
      <div className="ecosystem-heading" data-reveal>
        ...
        <div dir="rtl">
          ...
          <p>
            أول منتج هو 001 Guardian، والمنتج الحصري الثاني قيد التطوير،
            وراح نكشف اسمه وهويته رسميًا وقت ما يكون جاهز.
          </p>
        </div>
      </div>
      ...
      <div className="future-slot" data-reveal>
        <div>
          <span>+</span>
          <strong>FUTURE PRODUCT SLOT</strong>
        </div>
        <p dir="rtl">
          مساحة جاهزة للمنتجات القادمة — نضيف 004 و005 وما بعدها بدون إعادة بناء المنصة.
        </p>
      </div>
    </section>
  )
  ...
  return (
    <section className="final-install" data-reveal>
      ...
      <div>
        ...
        <h2>Ready after the <span>guide?</span></h2>
        <p dir="rtl">
          راجع دليل الاستخدام والأسئلة المهمة، وبعدها ثبّت 001 Guardian من الرابط الرسمي.
        </p>
      </div>
