...
const navigationItems = [
  ...
  { label: "Products", href: "#bots" },
  { label: "Available", href: "#available" },
  { label: "001 Guardian", href: "#guardian-product" },
  { label: "Docs", href: "#guardian-guide" },
      ...
      <div className="built-zero-heading">
        ...
        <div dir="rtl">
          ...
          <p>
            ...
            الفكرة والبنية والمنطق الداخلي إلى الواجهة والهوية وتجربة الاستخدام النهائية.
          </p>
        </div>
      </div>
...
function GuardianProductHub() {
  return <GuardianExperience inviteUrl={GUARDIAN_INVITE_URL} />
}
  ...
  return (
    <section className="final-install" data-reveal>
      ...
      <div>
        ...
        <h2>Understand it. Then <span>deploy it.</span></h2>
        <p dir="rtl">
